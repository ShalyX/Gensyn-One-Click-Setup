...
# --- Configuration ---
REPO_URL="git@github.com:gensyn/rl-swarm.git"  # Official Gensyn repo (confirm this URL is correct before final deployment)
REPO_DIR="rl-swarm"
SCREEN_NAME="gensyn"
...
git clone "$REPO_URL" || log_error "Failed to clone repository. Check URL and network connection."
